...
$posts_number = get_theme_mod( 'greentech_blog_number', 6 );
...
<section class="section--blog">
	<h2 class="section-title"><?php echo esc_html( get_theme_mod( 'blog_section_title', __( 'Latest News', 'greentech' ) ) ); ?></h2>
	<div class="container">
				...
				<div class="section-blog__item">
					<?php if ( has_post_thumbnail() ) : ?>
						<div class="section-blog__thumbnails">
							<a href="<?php echo esc_url( get_permalink() ); ?>"><?php the_post_thumbnail( 'greentech-project' ); ?></a>
						</div>
						<h3 class="section-blog__title"><a href="<?php echo esc_url( the_permalink() ) ?>" alt="<?php echo esc_attr( the_title() ); ?>"><?php the_title(); ?></a></h3>
						<div class="entry-meta"><?php greentech_posted_on() ?></div>
					<?php else : ?>
						<h3 class="section-blog__title"><a href="<?php echo esc_url( the_permalink() ) ?>" alt="<?php echo esc_attr( the_title() ); ?>"><?php the_title(); ?></a></h3>
						<?php the_excerpt() ?>
						<div class="entry-meta"><?php greentech_posted_on() ?></div>
