...
$image = get_theme_mod( 'services_section_img', $services_bg_default );
...
<section class="section--services">
	<h2 class="section-title"><?php echo esc_html( get_theme_mod( 'services_section_title', __( 'Services', 'greentech' ) ) ); ?></h2>
