...
$cta_text = get_theme_mod( 'cta_text', __( 'Join us now to access the new tech', 'greentech' ) );
$cta_button_url = get_theme_mod( 'cta_button_url', 'https://gretathemes.com/' );
$cta_button_text = get_theme_mod( 'cta_button_text', __( 'Get In Touch', 'greentech' ) );
