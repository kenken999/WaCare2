...
if ( ! function_exists( 'greentech_setup' ) ) :
	/**
	...
	function greentech_setup() {
		...
		// Add image size.
		add_image_size( 'greentech-recent-posts', 100, 100, true );
		add_image_size( 'greentech-project', 370, 235, true );
...
function greentech_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'greentech_content_width', 770 );
}
...
function greentech_scripts() {
	...
	wp_enqueue_style( 'greentech-fonts', greentech_fonts_url() );
 ...
 */
function greentech_fonts_url() {
	$fonts   = array();
	$subsets = 'latin,latin-ext';

	if ( 'off' !== _x( 'on', 'Roboto Slab font: on or off', 'greentech' ) ) {
...
function greentech_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Topbar Left', 'greentech' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add widgets here.', 'greentech' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Topbar Right', 'greentech' ),
		'id'            => 'sidebar-3',
		'description'   => esc_html__( 'Add widgets here.', 'greentech' ),
		'before_widget' => '<section id="%1$s" class="%2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer', 'greentech' ),
		'id'            => 'sidebar-4',
		'description'   => esc_html__( 'Add widgets here.', 'greentech' ),
	...
	require_once get_template_directory() . '/inc/widgets/class-greentech-recent-posts-widget.php';
	register_widget( 'Greentech_Recent_Posts_Widget' );
}
 ...
 * Add editor style.
 */
function greentech_add_editor_styles() {
...
add_action( 'init', 'greentech_add_editor_styles' );
 ...
 * Load dashboard
 */
require get_template_directory() . '/inc/dashboard/class-greentech-dashboard.php';
$dashboard = new Greentech_Dashboard();
